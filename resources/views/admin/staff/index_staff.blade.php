                                ...
                                @if ($staff->usertype !== 'Admin' && $staff->usertype !== 'Owner')
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/admin/staff/edit', $staff->id) }}" class="btn btn-success"><i class="bx bxs-edit"></i></a>
                                ...
                                tableData += `
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- Delete Button -->
                                            <form action="{{ url('admin/staff/delete/') }}/${staff.id}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
