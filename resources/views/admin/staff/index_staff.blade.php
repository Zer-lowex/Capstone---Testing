                                ...
                                @foreach ($users as $staff)
                                    @if ($staff->usertype !== 'Admin' && $staff->usertype !== 'Owner')
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                    data-bs-target="#staffDetailModal-{{ $staff->id }}">
                                                    <i class="bx bxs-user-detail"></i>
                                                </button>
                                                <a href="{{ url('/admin/staff/edit', $staff->id) }}"
                                                    class="btn btn-success"><i class="bx bxs-edit"></i></a>
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                    data-bs-target="#deleteStaffModal" data-id="{{ $staff->id }}">
                                        ...
                                        <div class="modal fade" id="staffDetailModal-{{ $staff->id }}" tabindex="-1"
                                            aria-labelledby="staffDetailModalLabel-{{ $staff->id }}" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0 shadow-lg">
                                                    <div class="modal-header text-black justify-content-center">
                                                        <h5 class="modal-title fw-bold"
                                                            id="staffDetailModalLabel-{{ $staff->id }}">Staff Details
                                                        </h5>
                                                    ...
                                                    <div class="modal-body p-4">
                                                        ...
                                                        <p><strong>Name:</strong> {{ $staff->first_name }}
                                                            {{ $staff->last_name }}</p>
                                                        ...
                                                        <p><strong>Status:</strong> <span
                                                                class="{{ $staff->status === 'Online' ? 'text-success' : '' }}">{{ $staff->status }}</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content border-0 shadow-lg">
                            ...
                            <div class="modal-body p-4">
                                ...
                                <div class="mt-3">
                                    <p class="text-muted small">Note: The default password for the staff account is
                                        <strong>Password123</strong>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    success: function(data) {
                        ...
                        if (data.length > 0) {
                            data.forEach(function(staff) {
                                if (staff.usertype !== 'Admin' && staff.usertype !==
                                    'Owner') {
                                    tableData += `
                                    <tr>
                                        <td>${staff.first_name}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/admin/staff/edit') }}/${staff.id}" class="btn btn-success">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteStaffModal.addEventListener('show.bs.modal', function(event) {
                ...
                deleteStaffForm.action = `/admin/staff/delete/${staffId}`;
            });
        });
    </script>
