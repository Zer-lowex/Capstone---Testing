                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('supplier.edit', $supplier->id) }}" class="btn btn-success"><i class="bx bxs-edit"></i></a>
                        ...
                        tableData += `
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('admin/supplier/edit/') }}/${supplier.id}" class="btn btn-success"><i class="bx bxs-edit"></i></a>
                                    <form action="{{ url('admin/supplier/delete/') }}/${supplier.id}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
...
<script> 
    document.addEventListener('DOMContentLoaded', function () {
        ...
        deleteSupplierModal.addEventListener('show.bs.modal', function (event) {
            ...
            deleteSupplierForm.action = `/admin/supplier/delete/${supplierId}`;
        });
    });
...
<script>
    $(document).ready(function() {
        ...
        if (supplierId) {
            ...
            $.ajax({
                url: '/admin/supplier/details/' + supplierId,
                type: 'GET',
                success: function(supplier) {
                    ...
                    // Load products
                    $.ajax({
                        url: '/admin/supplier/products/' + supplierId,
                        type: 'GET',
