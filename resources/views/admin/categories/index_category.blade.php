                    ...
                    data.forEach(function(category) {
                        tableData += `
                            <tr>
                                ...
                                <td>${category.name}</td>
                                <td>
                                    <a href="{{ url('admin/category/edit/') }}/${category.id}" class="btn btn-success"><i class="bx bxs-edit"></i></a>
                                    <form action="{{ url('admin/category/delete/') }}/${category.id}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        deleteCategoryModal.addEventListener('show.bs.modal', function (event) {
            ...
            deleteCategoryForm.action = `/admin/category/delete/${categoryId}`;
        });
    });
</script>
