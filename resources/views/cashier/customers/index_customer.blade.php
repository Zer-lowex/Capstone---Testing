                            ...
                            <div class="modal-body p-4">
                                <form action="{{ url('/cashier/customers/add') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="tel" name="phone" class="form-control rounded-3" placeholder="Enter Customer Phone" />
                                        @error('phone') <span class="text-danger small">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Address</label>
                                        <input type="text" name="address" class="form-control rounded-3" placeholder="Enter Customer Address" />
...
<script>
    ...
    $('#customerSearch').on('keyup', function() {
        ...
        $.ajax({
            url: '{{ route('cashier.customer.search') }}',
            type: 'GET',
