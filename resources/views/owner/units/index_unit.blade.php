                            ...
                            <tbody>
                                @foreach ($units as $unit)
                                    <tr>
                                        ...
                                        <td>{{ $unit->name }}</td>
                                        {{-- <td>
                                            <a href="{{ route('owner.unit.edit', $unit->id) }}" class="btn btn-success"><i
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content border-0 shadow-lg">
                                ...
                                <div class="modal-body p-4">
                                    <form action="{{ route('owner.unit.add') }}" method="POST">
                                        @csrf
                                        <div class="mb-3">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.length > 0) {
                    ...
                    tableData = `<tr><td colspan="2">No results found</td></tr>`;
                }
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        deleteUnitModal.addEventListener('show.bs.modal', function (event) {
            ...
            deleteUnitForm.action = `/owner/unit/delete/${unitId}`;
        });
    });
