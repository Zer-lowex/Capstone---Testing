...
<ul class="side-menu">
    ...
    <li><a href="{{ url('owner/settings/profile') }}"><i class='bx bxs-user-circle icon'></i> Profile</a></li>
    <li class="divider" data-text="System">System</li>
    <li><a href="{{ url('owner/settings/alerts') }}"><i class='bx bxs-bell-ring icon'></i> Alerts</a></li>
    <li><a href="{{ url('owner/settings/site') }}"><i class='bx bxs-server icon'></i> Product List</a></li>
