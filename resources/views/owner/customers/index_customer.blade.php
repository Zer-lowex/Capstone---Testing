                        ...
                        <table id="customerTable" class="table table-striped table-bordered text-center align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    {{-- <td>
                                        <a href="{{ url('/owner/customers/edit', $customer->id) }}" class="btn btn-success"><i class="bx bxs-edit"></i></a>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content border-0 shadow-lg">
                            ...
                            <div class="modal-body p-4">
                                <form action="{{ route('owner.customer.add') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
...
<script>
    ...
    $('#customerSearch').on('keyup', function() {
        ...
        $.ajax({
            url: '{{ route('owner.customer.search') }}',
            type: 'GET',
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        deleteCustomerModal.addEventListener('show.bs.modal', function (event) {
            ...
            deleteCustomerForm.action = `/owner/customers/delete/${customerId}`;
        });
    });
</script>
@endsection
