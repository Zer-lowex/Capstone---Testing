    ...
    <div class="info-data">
        <div class="card">
            ...
            <div class="collapse" id="filterOptions">
                <div class="info-data">
                    <form action="{{ url('/owner/activityLog') }}" method="GET">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4 d-flex align-items-end">
                                ...
                                <a href="{{ url('/owner/activityLog') }}" class="btn btn-primary ms-2">Clear Filters</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            deleteActivityLogModal.addEventListener('show.bs.modal', function (event) {
                ...
                deleteActivityLogForm.action = `/owner/activityLog/delete/${activityLogId}`;
            });
        });
    </script>
