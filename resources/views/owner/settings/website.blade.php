                    ...
                    <div class="card product-card h-100 border-0 shadow-sm">
                        <div class="position-relative">
                            ...
                            @if($product->quantity <= $product->reorder_level)
                                <span class="position-absolute top-0 end-0 bg-danger text-white small px-2 py-1 rounded-bl">
                                    <i class="bx bx-error-circle me-1"></i> Low Stock
                                </span>
                            @endif
                            
                            @if($product->expiration_date && $product->expiration_date < now()->addDays(30))
                                <span class="position-absolute top-0 start-0 bg-warning text-dark small px-2 py-1 rounded-br">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <div>
                                        ...
                                        <strong class="{{ $product->quantity <= $product->reorder_level ? 'text-danger' : 'text-success' }}">
                                            {{ $product->quantity }} {{ $product->unit ? $product->unit->name : 'units' }}
                                        </strong>
                                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative mb-3">
                            ...
                            <div class="text-center mt-3">
                                ...
                                <input type="file" id="productImageUpload" style="display: none;" accept="image/*">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-floating mb-3">
                                <textarea class="form-control" id="productDescriptionEdit" 
                                    placeholder="Edit description" style="height: 100px"></textarea>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.getElementById("productImageUpload").addEventListener("change", function (e) {
            ...
            fetch("{{ route('owner.site.update-image') }}", {
                method: "POST",
                headers: {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    const productCardImg = document.querySelector(`[data-product-id="${selectedProductId}"] .product-img`);
                    if (productCardImg) {
        ...
        document.getElementById("saveDescriptionBtn").addEventListener("click", function () {
            ...
            fetch("{{ route('owner.site.update-description') }}", {
                method: "PUT",
                headers: {
