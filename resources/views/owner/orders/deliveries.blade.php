            ...
            <div class="col-md-12">
                ...
                <div class="container-data">
                    <div class="head d-flex align-items-center justify-content-between">
                        ...
                        <form method="GET" action="{{ route('owner.delivery.view') }}">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#assignDriverModal" data-delivery-id="{{ $delivery->id }}">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content border-0 shadow-lg rounded-3">
                            ...
                            <div class="modal-header text-black">
                                <h5 class="modal-title fw-bold mx-auto" id="assignDriverModalLabel">Assign Driver to Delivery</h5>
...
<script>
    $(document).ready(function() {
        ...
        $('#assignDriverModal').on('show.bs.modal', function(event) {
            ...
            var deliveryId = button.data('delivery-id'); // Extract the delivery id from data-* attributes
