                        ...
                        <div class="col-md-6">
                            ...
                            @auth('customer')
                                <form method="POST" action="{{ route('customer.reserve.product') }}">
                                    ...
                                    <input type="hidden" name="quantity" id="hiddenProductQuantity" value="1">

                                    <button type="submit" class="btn btn-primary w-100 py-2" id="reserveProduct">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const updateTotalPrice = () => {
                ...
                const priceElement = document.getElementById('modalProductPrice');
                    ...
                    setTimeout(() => priceElement.classList.remove('price-update'), 200);
            ...
            decrementBtn.addEventListener('click', () => {
                quantityInput.value = Math.max(parseInt(quantityInput.min), parseInt(quantityInput.value) - 1);
                updateTotalPrice();
            });
    
            incrementBtn.addEventListener('click', () => {
                quantityInput.value = Math.min(parseInt(quantityInput.max), parseInt(quantityInput.value) + 1);
                updateTotalPrice();
            });
            ...
            productModal.addEventListener('show.bs.modal', function(event) {
                ...
                // Add warning icon if quantity is low
                if (quantity <= 5) {
