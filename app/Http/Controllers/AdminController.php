...
class AdminController extends Controller
{
    public function website()
    {
        ...
        return view('admin.settings.website', compact('products', 'categories'));
    }
    ...
    public function viewAlerts()
    {
        ...
        return view('admin.settings.alerts', compact('products'));
    }
    ...
    public function editCustomer($id)
    {
        ...
        return view('admin.customers.edit_customers', compact('customer'));
    }
    ...
    public function updateCustomer(Request $request, $id)
    {
        ...
        ActivityLog::create([
            'user_id' => $user->id,
            'action' => 'Update',
            'description' => "{$user->username} ({$usertype}) Updated Customer ID: $customer->id (Name: $customer->username)",
        ]);
    ...
    public function viewStaff()
    {
        ...
        return view('admin.staff.index_staff', [
            'users' => $users
        ]);
    }
    ...
    public function editStaff($id)
    {
        ...
        return view('admin.staff.edit_staff', compact('user'));
    }
    ...
    public function updateStaff(Request $request, $id)
    {
        ...
        $request->validate([
            'username' => 'required|string|max:255',
            'usertype' => 'required|string|in:Staff,Cashier,Driver',
            'first_name' => 'required|string|max:255',
            'last_name' => 'required|string|max:255',
        ...
        $data = $request->only(['username', 'usertype', 'first_name', 'last_name', 'email', 'phone', 'address']);
        ...
        ActivityLog::create([
            'user_id' => $user->id,
            'action' => 'Update',
            'description' => "{$user->username} ({$usertype}) Updated Staff ID: $staff->id ($staff->username)",
        ]);
    ...
    public function resetPassword(Request $request, $id)
    {
        ...
        ActivityLog::create([
            ...
            'description' => "{$admin->username} ({$admin->usertype}) Reset Password for Staff $user->id ($user->username)",
        ]);

        return redirect('/admin/staff')->with('success', 'Password reset successfully.');
    }
    ...
    public function viewProduct()
    {
        ...
        // Ensure all relationships have default values if null
        $products->getCollection()->transform(function ($product) {
            $product->category_name = $product->category->name ?? 'No Category';
            $product->supplier_name = $product->supplier->name ?? 'No Supplier';
            $product->unit_name = $product->unit->name ?? 'No Unit';
            return $product;
        });
    ...
    public function addStock(Request $request)
    {
        ...
        return redirect('/admin/products')->with('success', 'Added Product Stock Successfully');
    }
    ...
    public function editUnit($id)
    {
        ...
        return view('admin.units.edit_unit', compact('unit'));
    }
    ...
    public function viewSupplier()
    {
        ...
        return view('admin.supplier.index_supplier', compact('suppliers'));
    }
    ...
    public function deleteUnit($id)
    {
        ...
        return redirect('/admin/unit')->with('success', 'Unit Deleted Successfully');
    }
    ...
    public function viewOrders(Request $request)
    {
        ...
        return view('admin.orders.index_orders', compact('sales'));
    }
    ...
    public function viewDeliveries(Request $request)
    {
        ...
        return view('admin.orders.deliveries', [
    ...
    public function deleteactivityLog($id)
    {
        ...
        return redirect()->route('activityLog.view')->with('success', 'Activity Log Deleted Successfully');
    }
}
